                    ...
                    success: function (data) {
                        ...
                        if ($.isEmptyObject(data)){
                            ...
                            form.append(
                                ...
                                "<input readonly type=\"text\" class=\"form-control \" id=\"tempat_lahir\"\n" + "value=" + data.tempat_lahir + ">"
                            );
                            //tanggal lahir
                            form.append(
                                "<div class=\"form-group mb-3\">" +
                                "<label class=\"mr-3\"><strong>Tanggal Lahir</strong></label>" +
                                "<input readonly type=\"date\" class=\"form-control \" id=\"tgllahir\"\n" + "value=" + data.tanggal_lahir + ">"
                            );
                            //notelp
                            form.append(
                                "<div class=\"form-group mb-3\">" +
                                "<label class=\"mr-3\"><strong>No. Telp</strong></label>" +
                                "<input readonly type=\"number\" class=\"form-control \" id=\"notelp\"\n" + "value=" + data.no_telp + ">"
                            );
                            //user_type
                            form.append(
