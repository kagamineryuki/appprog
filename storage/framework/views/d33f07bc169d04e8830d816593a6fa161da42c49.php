    ...
    <div class="bg-light align-items-stretch" id="sidebar">
        <div class="list-group list-group-flush">
            <a href="/admin/admin_dashboard"
                class="list-group-item list-group-item-action <?php echo e(Request::is('admin/admin_dashboard')? 'active' : ''); ?>">Dashboard
            </a>

            <a href="/admin/admin_dashboard/create_user"
                class="list-group-item list-group-item-action <?php echo e(Request::is('admin/admin_dashboard/create_user')? 'active' : ''); ?>">Create Items

            </a>

            <a href="/admin/admin_dashboard/change_user"
                class="list-group-item list-group-item-action <?php echo e(Request::is('admin/admin_dashboard/change_user')? 'active' : ''); ?>">Update Items
            </a>
