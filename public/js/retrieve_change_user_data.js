...
$(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function success(data) {
                        ...
                        if ($.isEmptyObject(data)) {
                            ...
                            //name
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Name*</strong></label>" + "<input type='text' class='form-control' id='nama' value=\"" + data.nama + " \" >");
                            //alamat
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Address*</strong></label>" + "<input type=\"text\" class=\"form-control \" id=\"alamat\"\n" + "value=" + data.alamat + ">");
                            //tempat lahir
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Birthplace</strong></label>" + "<input type=\"text\" class=\"form-control \" id=\"tempat_lahir\"\n" + "value=" + data.tempat_lahir + ">");
                            //tanggal lahir
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Birthdate</strong></label>" + "<input type=\"date\" class=\"form-control \" id=\"tgllahir\"\n" + "value=" + data.tanggal_lahir + ">");
                            //notelp
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Phone Number</strong></label>" + "<input type=\"number\" class=\"form-control \" id=\"notelp\"\n" + "value=" + data.no_telp + ">");
                            //user_type
                ...
                $.ajax({
                    ...
                    success: function success(data) {
                        ...
                        if ($.isEmptyObject(data)) {
                            ...
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Name*</strong></label>" + "<input type='text' class='form-control' id='nama' value='" + data.nama + "'>");
                            //alamat
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Address*</strong></label>" + "<input type='text' class='form-control' id='alamat'" + "value=" + data.alamat + "'>");
                            //tempat lahir
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Birthplace</strong></label>" + "<input type='text' class='form-control' id='tempat_lahir' value='" + data.tempat_lahir + "'>");
                            //tanggal lahir
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Birthdate</strong></label>" + "<input type='date' class='form-control' id='tgllahir' value='" + data.tanggal_lahir + "'>");
                            //notelp
                            form.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Phone Number</strong></label>" + "<input type='number' class='form-control' id='notelp' value=" + data.no_telp + "'>");
                            //user_type
                            form.append("<input type='hidden' id ='user_type' value='" + user_type + "'>");
    ...
    function set_user_data(data) {
        $.ajax({
            ...
            failed: function failed(data, status) {
                console.log(data);
                console.log(status);
            }
        });
            ...
            success: function success(data) {
                ...
                if (data.error) {
                    ...
                    $.each(data, function (index, value) {
                        //nama pelajaran
                        form_pelajaran.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Lesson Name</strong></label>" + "<input type='text' class='form-control' id='nama_pelajaran' value='" + value.nama_pelajaran + "'>");
                    });
        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                if (data.error) {
                    ...
                    $.each(data, function (index, value) {
                        //nama pelajaran
                        form_kelas.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Class Name</strong></label>" + "<input type='text' class='form-control' id='nama_kelas' value='" + value.nama_kelas + "'>");
                    });
