            ...
            success: function success(data) {
                ...
                if (data.error) {
                    ...
                    $.each(data, function (index, value) {
                        //nama pelajaran
                        form_pelajaran.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Nama Pelajaran</strong></label>" + "<input type=\"text\" class=\"form-control \" id=\"nama_pelajaran\"\n" + "value=" + value.nama_pelajaran + ">");
                    });
        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                if (data.error) {
                    ...
                    $.each(data, function (index, value) {
                        //nama pelajaran
                        form_kelas.append("<div class=\"form-group mb-3\">" + "<label class=\"mr-3\"><strong>Nama Kelas</strong></label>" + "<input type=\"text\" class=\"form-control \" id=\"nama_kelas\"\n" + "value=" + value.nama_kelas + ">");
                    });
